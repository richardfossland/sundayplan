...
echo "→ idempotency: re-applying 0024_booking_rentals.sql"
run supabase/migrations/0024_booking_rentals.sql
echo "✓ rentals migration is idempotent (applied twice cleanly)"
